...
%%% retrieve the annotation of the TUMKitchen dataset
%%% Input: anno - the matlab structure generated by importdata of the
%%%               annotation file.
%%% Output: the semantic temporal ranges of different body parts
